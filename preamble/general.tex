...
\setlength{\textwidth}{14cm} % 10 pt font
% text height set by golden ratio
\areaset[current]{\textwidth}{1.8\textwidth}
...
\hypersetup{
  ...
  urlcolor=blue, linkcolor=blue, citecolor=blue, %pagecolor=Black,%
}
...
\newcommand{\nablaxy}{\nabla_{\perp}}
\newcommand{\lapxy}{\Delta_{\perp}}

%boxes
\usepackage{mdframed}
\mdtheorem[innertopmargin=-0.25em]{Remark}{Remark}[chapter]
\mdtheorem[innertopmargin=-1.5em]{BoxedText}{}[chapter]
